...
export const METRICS: Metric[] = [
  {
    ...
    value: '93.7K Followers',
    change: '+47.7K Follows Gained',
    isPositive: true,
    period: '1 Year',
    platformDetails: '93,688 total TikTok followers (+47,700 gained over 1 year, starting from 45,988).',
    data: [
      ...
      { name: 'Jul 26', value: 93688 },
    ],
  },
  {
    label: 'Meta Followers (FB + IG)',
    value: '61.8K Followers',
    change: '+57.7K Follows Gained',
    isPositive: true,
    period: '1 Year',
    platformDetails: 'Combined Meta audience: 52,000 Facebook followers + 9,800 Instagram followers.',
    data: [
      ...
      { name: 'Jul 26', value: 61800 },
    ],
  },
  {
    label: 'YouTube Subscribers',
    value: '49.2K Subscribers',
    change: '+9,814 Net Subs Gained',
    isPositive: true,
    period: '1 Year',
    platformDetails: '49,249 total YouTube subscribers with +9,814 net subscribers gained over 12 months.',
    data: [
