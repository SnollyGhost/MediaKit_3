              ...
              <motion.div
               ...
               >
                ...
                <div className="mb-3 relative">
                  ...
                  <div className="flex flex-col justify-center h-[72px] relative">
                    {isBlurred ? (
                      <div className="flex items-center justify-between w-full h-full">
                        <div className="flex flex-col select-none">
                          <span className="text-base font-bold text-white/20 line-through tracking-wider">
                      ...
                      <div className="flex flex-col justify-center h-full">
                        ...
                        <div className="text-3xl font-black tracking-tight text-white flex items-baseline gap-1.5 drop-shadow-sm">
                          <span className="bg-gradient-to-r from-white to-white/95 bg-clip-text text-transparent">
                            {currency === 'ETB' ? pkg.price : (pkg.usdPriceFormatted || `$${pkg.usdPrice.toLocaleString()}`)}
                          </span>
                        </div>
                      </div>
                    )}
